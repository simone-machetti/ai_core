    ...
    generate
        ...
        for (lane = 0; lane < NUM_LANES; lane++) begin : gen_lane
            ...
            for (cpr = 0; cpr < MULT_ARRAY_PP_PER_MUL; cpr++) begin : gen_cpr_n_2
                ...
                localparam int CPR_N_2_OUT_OFFSET = (lane * MULT_ARRAY_PP_PER_MUL * 2) + (cpr * 2);
                localparam int CPR_N_2_OUT_SHIFT  = (cpr - 1) * PP_SHIFT;
                localparam int CPR_N_2_OUT_APPEND = CPR_N_2_OUT_SHIFT + PP_SHIFT;
                ...
                if (cpr == 0) begin
                    ...
                    assign pp_o[CPR_N_2_OUT_OFFSET+0] = {{PP_SHIFT{pp_out[0][CPR_N_2_PP_OUT_WIDTH-1]}}, pp_out[0]};
                    assign pp_o[CPR_N_2_OUT_OFFSET+1] = {{PP_SHIFT{pp_out[1][CPR_N_2_PP_OUT_WIDTH-1]}}, pp_out[1]};

                end else begin

                    assign pp_o[CPR_N_2_OUT_OFFSET+0] = {pp_out[0][CPR_N_2_PP_OUT_WIDTH-CPR_N_2_OUT_SHIFT-1:0], {CPR_N_2_OUT_APPEND{1'b0}}};
                    assign pp_o[CPR_N_2_OUT_OFFSET+1] = {pp_out[1][CPR_N_2_PP_OUT_WIDTH-CPR_N_2_OUT_SHIFT-1:0], {CPR_N_2_OUT_APPEND{1'b0}}};
